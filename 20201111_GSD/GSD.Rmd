...
This R markdown file accompanies the [twitter thread](https://twitter.com/numbersman77/status/1326548973411135490?s=20) and provides the code to reproduce all computations. It heavily borrows from code within the [rpact project](http://www.rpact.org). Find the code on [github](https://github.com/numbersman77/twitter.git).
